...
\end{algorithm}
\begin{algorithm}
	\caption{\texttt{class TPCClientHandler}}
	\begin{algorithmic}
...
\subsection{Test}
\begin{compactitem}
	\item Test whether the correctness location of consistent hashing: \texttt{findFirstReplica} and \texttt{findSuccessor};
	\item Test whether the client handler calls the correct methods of \texttt{tpcmaster}
\end{compactitem}
\section{Task 4}
\subsection{Overview}
